 /*
 * $Id: Usages.java,v 1.29 2005/05/12 18:37:22 surajacharya Exp $
...
/**
 * The static methods of this class should be the only interface to the lisp
 * code.
 *
 * @version 1.0
 */
public class Usages {
    ...
    public static void getAllClasses (PrintStream out) {
        ...
        for (Iterator i = results.iterator();i.hasNext();) {
            ...
            if (index != -1)
                out.print ("\"" + uqName + "|" + clazz.substring (0, index+1) + "\"");
            else
                out.print ("\"" + clazz + "\"");
    ...
    public static boolean classExists (String className) {
        return getCurrentIUsages().classExists (className);
    }
